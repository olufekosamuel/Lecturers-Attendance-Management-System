...
<body>
  ...
  <form method="post" action="login.php">
	...
	<div style = "font-size:11px; color:#cc0000; margin-top:10px"><?php echo $emailErr; ?></div>
  	<div class="input-group">
  		<label>Password</label>
  		<input type="password" name="password">
  	</div>
	<div style = "font-size:11px; color:#cc0000; margin-top:10px"><?php echo $passwordErr; ?></div>
  	<div class="input-group">
  		<button type="submit" class="btn" name="login_user">Login</button>
  	</div>
	<div style = "font-size:11px; color:#cc0000; margin-top:10px"><?php echo $websiteErr; ?></div>
  	<p>
